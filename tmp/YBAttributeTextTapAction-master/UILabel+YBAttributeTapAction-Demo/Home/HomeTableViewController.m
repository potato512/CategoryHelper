...
[alert show];
@interface HomeTableViewController () <YBAttributeTapActionDelegate, UILabelClickDelegate>
...
//        }];
        [cell.testTapLabel labelClickAddWithStrings:@[@"lyb5834@126.com",@"lyb5834@126.com",@"lyb5834@126.com"] clicked:^(UILabel * _Nonnull label, NSString * _Nonnull string, NSRange range, NSInteger index) {
            YBAlertShow(string, @"block 知道了");
        }];
...
//            YBAlertShow(message, @"知道了");
//        }];
        [cell.testTapLabel labelClickAddWithStrings:@[@"13987654321",@"15888888888"] clicked:^(UILabel * _Nonnull label, NSString * _Nonnull string, NSRange range, NSInteger index) {
            YBAlertShow(string, @"block 知道了");
        }];
...
//        [cell.testTapLabel yb_addAttributeTapActionWithStrings:@[@"测试点击"] delegate:self];
        [cell.testTapLabel labelClickAddWithStrings:@[@"测试点击"] delegate:self];
...
//            YBAlertShow(message, @"知道了");
//        }];
        [cell.testTapLabel labelClickAddWithStrings:@[@"￥50"] clicked:^(UILabel * _Nonnull label, NSString * _Nonnull string, NSRange range, NSInteger index) {
            YBAlertShow(string, @"block 知道了");
        }];
...
//            YBAlertShow(message, @"知道了");
//        }];
        [cell.testTapLabel labelClickAddWithStrings:@[@"https://github.com/lyb5834/YBAttributeTextTapAction"] clicked:^(UILabel * _Nonnull label, NSString * _Nonnull string, NSRange range, NSInteger index) {
            YBAlertShow(string, @"block 知道了");
        }];
...
//        [cell.testTapLabel yb_addAttributeTapActionWithStrings:@[@"\"点我跳下一页\""] delegate:self];
        [cell.testTapLabel labelClickAddWithRanges:@[@"\"点我跳下一页\""] delegate:self];
    }else {
...
//        [cell.testTapLabel yb_removeAttributeTapActions];
        [cell.testTapLabel labelClickRemove];
    }
...
//
//        }];
        [button.titleLabel labelClickAddWithStrings:@[@"《用户注册协议》",@"《用户使用协议》",@"《用户保密协议》",@"《平台使用守则》",@"《平台免责申明》",@"《网络安全协议》"] clicked:^(UILabel * _Nonnull label, NSString * _Nonnull string, NSRange range, NSInteger index) {
            YBAlertShow(string, @"block 知道了");
        }];
    }
...
{
    YBAlertShow(string, @"delegate 知道了");
}
