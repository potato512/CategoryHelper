...
#import "UIActionSheet+SYCategory.h"
...
@implementation UIActionSheet (SYCategory)
              ...
              onCancel:(void (^)(void))cancel
{
    ...
    if (cancelButtonTitle && [cancelButtonTitle isKindOfClass:NSString.class] && 0 != cancelButtonTitle.length) {
