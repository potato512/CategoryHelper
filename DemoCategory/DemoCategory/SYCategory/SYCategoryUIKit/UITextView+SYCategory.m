...
static NSString *const keyMaxLengthTextView = @"limitMaxLengthTextView";
static NSString *const keyLimitTextView = @"limitTextView";

static NSString *const keyPlaceholderLabelTextView = @"placeholderLabelTextView";
static NSString *const keyPlaceholderTextView = @"placeholderTextView";
static NSString *const keyPlaceholderFontTextView = @"placeholderFontTextView";
static NSString *const keyPlaceholderColorTextView = @"placeholderColorTextView";
...
{
    objc_setAssociatedObject(self, &keyPlaceholderLabelTextView, placeholderLabel, OBJC_ASSOCIATION_RETAIN);
}

- (UILabel *)placeholderLabel
{
    UILabel *label = objc_getAssociatedObject(self, &keyPlaceholderLabelTextView);
    return label;
}
...
{
    objc_setAssociatedObject(self, &keyPlaceholderTextView, placeHolderText, OBJC_ASSOCIATION_RETAIN);
...
{
    NSString *string = objc_getAssociatedObject(self, &keyPlaceholderTextView);
    return string;
}
...
{
    objc_setAssociatedObject(self, &keyPlaceholderFontTextView, placeHolderTextFont, OBJC_ASSOCIATION_RETAIN);
    [self performSelector:@selector(refreshPlaceholderFont) withObject:nil];
}

- (UIFont *)placeHolderTextFont
{
    UIFont *font = objc_getAssociatedObject(self, &keyPlaceholderFontTextView);
    return font;
}
...
{
    objc_setAssociatedObject(self, &keyPlaceholderColorTextView, placeHolderTextColor, OBJC_ASSOCIATION_RETAIN);
    [self performSelector:@selector(refreshPlaceholderColor) withObject:nil];
}

- (UIColor *)placeHolderTextColor
{
    UIColor *color = objc_getAssociatedObject(self, &keyPlaceholderColorTextView);
    return color;
}
...
- (void)setLimitMaxLength:(NSNumber *)limitMaxLength
{
    ...
    {
        objc_setAssociatedObject(self, &keyMaxLengthTextView, limitMaxLength, OBJC_ASSOCIATION_RETAIN);
...
{
    NSNumber *limitMaxLength = objc_getAssociatedObject(self, &keyMaxLengthTextView);
...
- (void)setLimitText:(NSString *)limitText
{
    ...
    {
        objc_setAssociatedObject(self, &keyLimitTextView, limitText, OBJC_ASSOCIATION_RETAIN);
...
- (NSString *)limitText
{
    NSString *limitText = objc_getAssociatedObject(self, &keyLimitTextView);
    return limitText;
}
