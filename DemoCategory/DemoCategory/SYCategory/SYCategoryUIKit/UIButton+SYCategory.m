...
static NSString *const keyButtonClick = @"keyButtonClick";


static NSTimeInterval const timeSize = 1.0;

static NSString *const keyButtonCountdownType = @"keyButtonCountdownType";
static NSString *const keyButtonTitleNormal = @"keyButtonTitleNormal";
static NSString *const keyButtonTitleDisabledStart = @"keyButtonTitleDisabledStart";
static NSString *const keyButtonTitleDisabledFinish = @"keyButtonTitleDisabledFinish";
static NSString *const keyButtonTitleFont = @"keyButtonTitleFont";
static NSString *const keyButtonTitleColorNormal = @"keyButtonTitleColorNormal";
static NSString *const keyButtonTitleColorDisabled = @"keyButtonTitleColorDisabled";

static NSString *const keyButtonUIActivityIndicatorView = @"keyButtonUIActivityIndicatorView";
static NSString *const keyButtonStartTypeNumber = @"keyButtonStartTypeNumber";
static NSString *const keyButtonTimeNumber = @"keyButtonTimeNumber";
static NSString *const keyButtonSourceCountdownTimeNumber = @"keyButtonSourceCountdownTimeNumber";
...
- (void)setTitleNormal:(NSString *)titleNormal
{
    if (titleNormal)
    {
        ...
        objc_setAssociatedObject(self, &keyButtonTitleNormal, titleNormal, OBJC_ASSOCIATION_RETAIN);
    }
}

- (NSString * )titleNormal
{
    NSString *string = objc_getAssociatedObject(self, &keyButtonTitleNormal);
    return string;
}
...
- (void)setTitleDisabledStart:(NSString *)titleDisabledStart
{
    if (titleDisabledStart)
    {
        ...
        objc_setAssociatedObject(self, &keyButtonTitleDisabledStart, titleDisabledStart, OBJC_ASSOCIATION_RETAIN);
    }
}

- (NSString *)titleDisabledStart
{
    NSString *string = objc_getAssociatedObject(self, &keyButtonTitleDisabledStart);
    return string;
}
...
- (void)setTitleDisabledFinish:(NSString *)titleDisabledFinish
{
    if (titleDisabledFinish)
    {
        ...
        objc_setAssociatedObject(self, &keyButtonTitleDisabledFinish, titleDisabledFinish, OBJC_ASSOCIATION_RETAIN);
    }
}

- (NSString *)titleDisabledFinish
{
    NSString *string = objc_getAssociatedObject(self, &keyButtonTitleDisabledFinish);
    return string;
}
...
- (void)setTitleFont:(UIFont *)titleFont
{
    if (titleFont)
    {
        ...
        objc_setAssociatedObject(self, &keyButtonTitleFont, titleFont, OBJC_ASSOCIATION_RETAIN);
    }
}

- (UIFont *)titleFont
{
    UIFont *font = objc_getAssociatedObject(self, &keyButtonTitleFont);
    return font;
}
...
- (void)setColorNormal:(UIColor *)colorNormal
{
    if (colorNormal)
    {
        ...
        objc_setAssociatedObject(self, &keyButtonTitleColorNormal, colorNormal, OBJC_ASSOCIATION_RETAIN);
    }
}

- (UIColor *)colorNormal
{
    UIColor *color = objc_getAssociatedObject(self, &keyButtonTitleColorNormal);
    return color;
}
...
- (void)setColorDisabled:(UIColor *)colorDisabled
{
    if (colorDisabled)
    {
        ...
        objc_setAssociatedObject(self, &keyButtonTitleColorDisabled, colorDisabled, OBJC_ASSOCIATION_RETAIN);
    }
}

- (UIColor *)colorDisabled
{
    UIColor *color = objc_getAssociatedObject(self, &keyButtonTitleColorDisabled);
    return color;
}

- (void)setButtonCountdownTypeNumber:(NSNumber *)buttonCountdownTypeNumber
{
    objc_setAssociatedObject(self, &keyButtonCountdownType, buttonCountdownTypeNumber, OBJC_ASSOCIATION_RETAIN);
}

- (NSNumber *)buttonCountdownTypeNumber
{
    NSNumber *number = objc_getAssociatedObject(self, &keyButtonCountdownType);
    return number;
}

- (void)setActivityView:(UIActivityIndicatorView *)activityView
{
    objc_setAssociatedObject(self, &keyButtonUIActivityIndicatorView, activityView, OBJC_ASSOCIATION_RETAIN);
}

- (UIActivityIndicatorView *)activityView
{
    UIActivityIndicatorView *activityView = objc_getAssociatedObject(self, &keyButtonUIActivityIndicatorView);
    return activityView;
}

- (void)setStartTypeNumber:(NSNumber *)startTypeNumber
{
    objc_setAssociatedObject(self, &keyButtonStartTypeNumber, startTypeNumber, OBJC_ASSOCIATION_RETAIN);
}

- (NSNumber *)startTypeNumber
{
    NSNumber *number = objc_getAssociatedObject(self, &keyButtonStartTypeNumber);
    return number;
}

- (void)setCountdownTime:(NSNumber *)countdownTime
{
    objc_setAssociatedObject(self, &keyButtonTimeNumber, countdownTime, OBJC_ASSOCIATION_RETAIN);
}

- (NSNumber *)countdownTime
{
    NSNumber *number = objc_getAssociatedObject(self, &keyButtonTimeNumber);
    return number;
}

- (void)setSourceCountdownTime:(NSNumber *)sourceCountdownTime
{
    objc_setAssociatedObject(self, &keyButtonSourceCountdownTimeNumber, sourceCountdownTime, OBJC_ASSOCIATION_RETAIN);
}

- (NSNumber *)sourceCountdownTime
{
    NSNumber *number = objc_getAssociatedObject(self, &keyButtonSourceCountdownTimeNumber);
    return number;
}
